...
import { TADashboardInitModel, TravelAuthorizationSearchModel, TravelAuthorizationViewModel } from 'src/app/core/models/travel-authorisation-model/travelAuthorisation.model';
...
@Component({
  selector: 'app-travel-auth-dashboard',
  templateUrl: './travel-auth-dashboard.component.html',
  styleUrls: ['./travel-auth-dashboard.component.scss']
})
export class TravelAuthDashboardComponent implements OnInit, OnDestroy {

  subSink: SubSink;
  listData: TravelAuthorizationViewModel[];
  initModel:TADashboardInitModel;
